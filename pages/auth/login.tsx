        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between">
            <div className="text-sm">
              <Link href="/auth/recuperar-senha" className="font-medium text-primary-600 hover:text-primary-500">
                Esqueceu sua senha?
              </Link>
            </div>
            <div className="text-sm">
              <Link href="/auth/registro" className="font-medium text-primary-600 hover:text-primary-500">
                Criar conta
              </Link>
            </div>
          </div>
